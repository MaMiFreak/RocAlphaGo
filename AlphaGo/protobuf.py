...
def run_protobuf( cmd_line_args = None ):
    ...
    # required args
    parser.add_argument( "out_directory",   help= "directory where metadata and weights are stored." )
    parser.add_argument( "model",           help= "Path to a JSON model file (i.e. from CNNPolicy.save_model())" )
    parser.add_argument( "weights",         help= "Name of a .h5 weights file (in the output directory) to load." )
    # optional
